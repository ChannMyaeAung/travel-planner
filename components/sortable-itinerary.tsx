    ...
    >
      ...
      <div className="ml-8 flex justify-between items-center">
        ...
        <div className="flex-shrink-0 ml-4">
          <div className="bg-gradient-to-br from-blue-600 to-purple-600 text-white text-sm font-bold px-3 py-2 rounded-lg shadow-md">
            Day {item.order + 1}
          </div>
        </div>
      </div>
      ...
      <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 opacity-0 group-hover:opacity-20 transition-opacity duration-200 pointer-events-none" />
    </div>
  );
}
