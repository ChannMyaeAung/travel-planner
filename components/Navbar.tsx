...
export default function Navbar({ session }: { session: Session | null }) {
  return (
    <nav className="py-4 bg-white border-b border-gray-200 shadow-md">
      <div className="container flex items-center justify-between px-6 mx-auto lg:px-8">
        ...
        <div className="flex items-center space-x-4">
          {session ? (
            <>
              ...
              <button
                className="flex items-center justify-center p-2 text-white transition-all bg-gray-800 rounded-sm cursor-pointer hover:bg-gray-900"
                onClick={logout}
              >
                Sign Out
              </button>
