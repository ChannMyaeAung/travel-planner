...
import { ArrowLeft, Calendar, FileText, Camera, Plane, X } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-base font-semibold text-slate-900">Create New Trip</h1>
        ...
        >
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-3 shadow-sm">
            ...
            <textarea
              name="description"
              rows={4}
              placeholder="What are you excited about? Any must-see places or special occasions?"
              required
              className={cn(
                "w-full border border-slate-200 px-4 py-2.5 rounded-lg text-slate-900",
